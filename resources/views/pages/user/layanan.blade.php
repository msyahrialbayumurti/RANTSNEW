        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                dateClick: function(info) {
                    const eventsOnDate = eventsFromDatabase.filter(event => event.start === info
                        .dateStr);
                    ...
                    if (eventsOnDate.length > 0) {
                        ...
                        eventDetailsEl.innerHTML =
                            "<p class='text-gray-500 italic'>Tidak ada acara pada tanggal ini.</p>";
                    }
                },
    ...
    <main class="bg-gray-100">
        <div class="container mx-auto p-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
                <!-- Kalender -->
                <div
                    class="bg-white shadow-lg rounded-lg p-6 lg:col-span-2 flex flex-col items-center lg:items-start calendar-container">
                    <h2 class="text-lg font-bold text-gray-700 mb-4">Jadwal Layanan</h2>
                    <div id="calendar"
                        class="w-full rounded-lg border border-gray-200 shadow-sm bg-gradient-to-r from-blue-100 to-blue-200 calendar">
                    </div>
                ...
                service.addEventListener('click', function() {
                    ...
                    if (activeService !== layanan) {
                        ...
                        fetch(url)
                            ...
                            .then(data => {
                                ...
                                if (data.data && data.data.length > 0) {
                                    data.data.forEach(item => {
                                        const imageUrl =
                                            `/storage/${item.image || 'default-image.jpg'}`;
                                        produkLists[layanan].innerHTML += `
                                ...
                                `;
                                    ...
                                    produkLists[layanan].innerHTML =
                                        '<p class="text-gray-500 italic">Tidak ada produk untuk layanan ini.</p>';
                                }
                            ...
                            .catch(error => {
                                produkLists[layanan].innerHTML =
                                    '<p class="text-red-500 italic">Terjadi kesalahan saat memuat produk.</p>';
                                console.error(error);
                            });
                    }
                });
            ...
            <form id="order-form">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="product-name" name="product-name"
                        class="w-full mt-1 p-2 border rounded-lg" readonly>
                </div>
                <div class="mb-4">
                    <label for="quantity" class="block text-sm font-medium text-gray-700">Jumlah</label>
                    <input type="number" id="quantity" name="quantity" class="w-full mt-1 p-2 border rounded-lg"
                        min="1" required>
                </div>
                <div class="mb-4">
                ...
                <div class="flex justify-end space-x-4">
                    ...
                    <button type="submit"
                        class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg">Lanjutkan ke
                        Pembayaran</button>
                </div>
            </form>
        </div>
